...
\begin{itemize}
    \item TrxManager: contiene tutti i metodi per l'accesso al database
    \item SIoTBitcoinClient: è il TrxClient, viene incapsulato nel WalletWrapper
...
metodi per:
- inserire le ricariche nel db
- confermarle
- prendere le readAPIkeys memorizzate nel db
- rendere disponibili
...
